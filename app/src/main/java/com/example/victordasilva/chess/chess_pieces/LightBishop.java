...
public class LightBishop implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public LightBishop(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.light_bishop);
