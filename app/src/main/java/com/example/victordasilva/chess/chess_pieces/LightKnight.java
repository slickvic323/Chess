...
public class LightKnight implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public LightKnight(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.light_knight);
