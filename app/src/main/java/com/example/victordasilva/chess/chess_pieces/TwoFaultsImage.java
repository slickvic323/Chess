...
public class TwoFaultsImage {

    private int x, y;
    private Bitmap bitmap;

    public TwoFaultsImage(Context context, int screenSizeY) {
        x = 5;
        y = screenSizeY - 90;
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.two_faults);
