...
public class LightQueen implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public LightQueen(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.light_queen);
