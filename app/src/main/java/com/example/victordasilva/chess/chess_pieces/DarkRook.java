...
public class DarkRook implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public DarkRook(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dark_rook);
