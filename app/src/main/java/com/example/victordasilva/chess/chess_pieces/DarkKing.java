...
public class DarkKing implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public DarkKing(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dark_king);
