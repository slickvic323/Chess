...
public class DarkPawn implements ChessPiece {
    private int x, y;
    ...
    //Constructor
    public DarkPawn(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dark_pawn);
