...
public class LightRook implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public LightRook(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.light_rook);
