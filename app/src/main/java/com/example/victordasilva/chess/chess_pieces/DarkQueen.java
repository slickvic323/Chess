...
public class DarkQueen implements ChessPiece{
    private int x, y;
    ...
    //Constructor
    public DarkQueen(Context context, int squareSize, int leftBoard, int topBoard) {
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dark_queen);
