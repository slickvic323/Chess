...
public class NoFaultsImage {

    private int x, y;
    private Bitmap bitmap;

    public NoFaultsImage(Context context, int screenSizeY) {
        x = 5;
        y = screenSizeY - 90;
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.no_faults);
